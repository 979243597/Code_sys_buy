...
func InitOptionMap() {
	...
	common.OptionMap["AIDeployerClientEnabled"] = strconv.FormatBool(common.GetEnvOrDefaultBool("AI_DEPLOYER_CLIENT_ENABLED", true))
	common.OptionMap["AIDeployerClientNotice"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_NOTICE", "")
	common.OptionMap["AIDeployerClientMinVersion"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_MIN_VERSION", "1.0.0")
	common.OptionMap["AIDeployerClientLatestVersion"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_LATEST_VERSION", "1.0.4")
	common.OptionMap["AIDeployerClientUpdateURL"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_UPDATE_URL", "")
	common.OptionMap["AIDeployerClientDefaultModel"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_DEFAULT_MODEL", "gpt-5.3-codex")
	common.OptionMap["AIDeployerClientDefaultOCModel"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_DEFAULT_OC_MODEL", "openai/gpt-5.3-codex")
	common.OptionMap["AIDeployerClientDefaultSmallModel"] = common.GetEnvOrDefaultString("AI_DEPLOYER_CLIENT_DEFAULT_SMALL_MODEL", "openai/gpt-4.1-mini")
