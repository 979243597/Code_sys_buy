...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		clientLicenseRoute := apiRouter.Group("/client_license")
		clientLicenseRoute.Use(middleware.AdminAuth())
		{
			clientLicenseRoute.GET("/", controller.GetAllClientLicenses)
			clientLicenseRoute.GET("/search", controller.SearchClientLicenses)
			clientLicenseRoute.GET("/:id", controller.GetClientLicense)
			clientLicenseRoute.POST("/", controller.AddClientLicense)
			clientLicenseRoute.PUT("/", controller.UpdateClientLicense)
			clientLicenseRoute.DELETE("/:id", controller.DeleteClientLicense)
		}
