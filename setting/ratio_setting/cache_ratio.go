...
var defaultCacheRatio = map[string]float64{
	...
	"gpt-5-openai-compact":                0.1,
	"gpt-5-codex":                         0.1,
	"gpt-5-codex-openai-compact":          0.1,
	"gpt-5-codex-mini":                    0.25,
	"gpt-5-codex-mini-openai-compact":     0.25,
	"gpt-5.1":                             0.1,
	"gpt-5.1-openai-compact":              0.1,
	"gpt-5.1-codex":                       0.1,
	"gpt-5.1-codex-openai-compact":        0.1,
	"gpt-5.1-codex-mini":                  0.1,
	"gpt-5.1-codex-mini-openai-compact":   0.1,
	"gpt-5.1-codex-max":                   0.1,
	"gpt-5.1-codex-max-openai-compact":    0.1,
	"gpt-5.2":                             0.1,
	"gpt-5.2-openai-compact":              0.1,
	"gpt-5.2-codex":                       0.1,
	"gpt-5.2-codex-openai-compact":        0.1,
	"gpt-5.3-codex":                       0.1,
	"gpt-5.3-codex-openai-compact":        0.1,
	"gpt-5.3-codex-spark-openai-compact":  0.1,
	"gpt-5.4":                             0.1,
	"gpt-5.4-openai-compact":              0.1,
	"gpt-5.4-mini":                        0.1,
	"gpt-5.4-mini-openai-compact":         0.1,
	"gpt-5-mini":                          0.1,
